...
This file is the quick-reference operating contract for allocative-kotlin. The longer
...
allocative-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`allocative`](https://crates.io/crates/allocative). Upstream Rust is the behavioral oracle while the
