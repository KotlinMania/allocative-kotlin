...
kotlin {
    ...
    val xcf = XCFramework("Allocative")
    ...
    swiftExport {
        moduleName = "Allocative"
        flattenPackage = "io.github.kotlinmania.allocative"
    }

    android {
        namespace = "io.github.kotlinmania.allocative"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "allocative-kotlin", version.toString())

    pom {
        name.set("allocative-kotlin")
        description.set("Kotlin Multiplatform port of facebookexperimental/allocative - Inspect rust object tree and output it as flamegraph")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/allocative-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/allocative-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/allocative-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/allocative-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAllocativeXCFramework",
    "assembleAllocativeDebugXCFramework",
    "assembleAllocativeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAllocativeXCFramework",
    "assembleReleaseIosFatFrameworkForAllocativeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAllocativeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAllocativeXCFramework",
    "assembleDebugMacosFatFrameworkForAllocativeXCFramework",
    "assembleReleaseMacosFatFrameworkForAllocativeXCFramework",
    "assembleDebugTvosFatFrameworkForAllocativeXCFramework",
    "assembleReleaseTvosFatFrameworkForAllocativeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAllocativeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAllocativeXCFramework",
    "assembleDebugWatchosFatFrameworkForAllocativeXCFramework",
    "assembleReleaseWatchosFatFrameworkForAllocativeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAllocativeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAllocativeXCFramework",
